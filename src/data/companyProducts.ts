...
const himaProducts: CompanyProduct[] = [
  {
    id: "hima-1",
    ...extractTitleParts("سدادة نثية / Female Blind Plug"),
    desc: "سدادة نثية محكمة لسد فتحات الأنابيب بفعالية",
    descEn: "Female blind plug for effectively sealing pipe openings",
    img: tawsil,
    factory: "hima",
    category: "ري",
  ...
  {
    id: "hima-2",
    ...extractTitleParts("سدادة ذكر / Male Head Plug"),
    desc: "سدادة ذكر محكمة مع آلية قفل لسد فتحات الأنابيب",
    descEn: "Male head plug with locking mechanism for sealing pipe openings",
    img: tawsil,
    factory: "hima",
    category: "ري",
    categoryEn: "Irrigation",
  ...
  {
    id: "hima-3",
    ...extractTitleParts("رأس نثية / Female Head"),
    desc: "رأس نثية للوصل والتوصيل بين الأنابيب",
    descEn: "Female head for connecting and joining pipes",
    img: rabit,
    factory: "hima",
    category: "ري",
    categoryEn: "Irrigation",
  ...
  {
    id: "hima-4",
    ...extractTitleParts("رأس ذكر / Male Head"),
    desc: "رأس ذكر مع آلية قفل سريعة للوصل والتوصيل",
    descEn: "Male head with quick-lock mechanism for connecting and joining",
    img: rabit,
    factory: "hima",
    category: "ري",
    categoryEn: "Irrigation",
  ...
  {
    id: "hima-17",
    ...extractTitleParts("نوزل مرشة / Sprinkler Nozzle (SPRINK)"),
    desc: "رأس رشاش عالي الجودة للري بالرش",
    descEn: "High-quality sprinkler nozzle for spray irrigation",
    img: marasha,
    factory: "hima",
    category: "ري",
    categoryEn: "Irrigation",
  ...
  {
    id: "hima-18",
    ...extractTitleParts("مرشة M-16 / Sprinkler M-16"),
    desc: "مرشة M-16 للري الزراعي بكفاءة عالية",
    descEn: "M-16 sprinkler for efficient agricultural irrigation",
    img: marasha,
    factory: "hima",
    category: "ري",
    categoryEn: "Irrigation",
  ...
  {
    id: "hima-19",
    ...extractTitleParts("مرشة A-42 / Sprinkler A-42"),
    desc: "مرشة A-42 متطورة للري الزراعي",
    descEn: "Advanced A-42 sprinkler for agricultural irrigation",
    img: marasha2,
    factory: "hima",
    category: "ري",
    categoryEn: "Irrigation",
  ...
  {
    id: "hima-20",
    ...extractTitleParts("مرشة G-30 / Sprinkler G-30"),
    desc: "مرشة G-30 قوية للري الزراعي الواسع",
    descEn: "Robust G-30 sprinkler for wide-area agricultural irrigation",
    img: marasha,
    factory: "hima",
    category: "ري",
    categoryEn: "Irrigation",
  ...
  {
    id: "hima-21",
    ...extractTitleParts("مرشة ORANGE / Sprinkler ORANGE (ORG)"),
    desc: "مرشة ORANGE للري بالرش بكفاءة عالية",
    descEn: "ORANGE sprinkler for high-efficiency spray irrigation",
    img: marasha2,
    factory: "hima",
    category: "ري",
    categoryEn: "Irrigation",
  ...
  {
    id: "hima-22",
    ...extractTitleParts("مرشة SE-10 / Sprinkler SE-10"),
    desc: "مرشة SE-10 للري الزراعي بكفاءة عالية",
    descEn: "SE-10 sprinkler for efficient agricultural irrigation",
    img: marasha,
    factory: "hima",
    category: "ري",
    categoryEn: "Irrigation",
  ...
  {
    id: "hima-23",
    ...extractTitleParts("مرشة PARS / Sprinkler PARS"),
    desc: "مرشة PARS مع ميزة المحمول الساحق للري الزراعي",
    descEn: "PARS sprinkler with portable crusher feature for agricultural irrigation",
    img: marasha,
    factory: "hima",
    category: "ري",
    categoryEn: "Irrigation",
  ...
  {
    id: "hima-24",
    ...extractTitleParts("مرشة SILVER / Sprinkler SILVER"),
    desc: "مرشة SILVER مع قاطع طريق قابل للتعديل للري الزراعي",
    descEn: "SILVER sprinkler with adjustable path cutter for agricultural irrigation",
    img: marasha2,
    factory: "hima",
    category: "ري",
    categoryEn: "Irrigation",
  ...
  {
    id: "hima-25",
    ...extractTitleParts("مرشة ATAK / Sprinkler ATAK"),
    desc: "مرشة ATAK قوية للري الزراعي الواسع",
    descEn: "Robust ATAK sprinkler for wide-area agricultural irrigation",
    img: marasha,
    factory: "hima",
    category: "ري",
    categoryEn: "Irrigation",
  ...
  {
    id: "hima-26",
    ...extractTitleParts("مرشة K-ATAK / Sprinkler K-ATAK"),
    desc: "مرشة K-ATAK متطورة للري الزراعي",
    descEn: "Advanced K-ATAK sprinkler for agricultural irrigation",
    img: marasha2,
    factory: "hima",
    category: "ري",
    categoryEn: "Irrigation",
