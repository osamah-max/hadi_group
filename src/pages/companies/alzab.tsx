...
const translations = {
  ar: {
    ...
    products: [
      {
        title: "أفلام بلاستيكية زراعية",
        img: product1,
        desc: "أغطية تربة وأنفاق ومستلزمات ري عالية الجودة",
      },
      {
        title: "عبوات وتغليف مرن",
        img: product2,
        desc: "عبوات وتغليف مرن للاستخدامات التجارية والصناعية",
      },
      {
        title: "منتجات مساندة",
        img: product3,
        desc: "منتجات مساندة للوجستيات والتوزيع",
      },
      {
        title: "أغشية الأسمدة",
        img: product4,
        desc: "أغشية الأسمدة لنباتات PET بمواصفات عالية",
      },
      {
        title: "حلول تغليف متكاملة",
        img: product5,
        desc: "حلول تغليف متكاملة للمشاريع الكبرى",
      },
      {
        title: "منتجات بلاستيكية متخصصة",
        img: product6,
        desc: "منتجات بلاستيكية متخصصة للقطاع الزراعي",
      },
    ],
  },
  en: {
    ...
    products: [
      {
        title: "Agricultural Plastic Films",
        img: product1,
        desc: "High-quality soil covers, tunnels, and irrigation supplies",
      },
      {
        title: "Flexible Containers & Packaging",
        img: product2,
        desc: "Flexible containers and packaging for commercial and industrial uses",
      },
      {
        title: "Supporting Products",
        img: product3,
        desc: "Supporting products for logistics and distribution",
      },
      {
        title: "Fertilizer Films",
        img: product4,
        desc: "High-specification fertilizer films for PET plants",
      },
      {
      ...
      {
        title: "Specialized Plastic Products",
        img: product6,
        desc: "Specialized plastic products for agricultural sector",
      },
    ],
  }
};
