...
const FACTORY_SLUG = "alzab";
import factoryHero from "../../assets/img/backgrounds/alzab_hero.jpg";

// Product images
import product1 from "../../assets/img/products/product/alzap -zip/product1@3x.png";
import product2 from "../../assets/img/products/product/alzap -zip/product2@3x.png";
import product3 from "../../assets/img/products/product/alzap -zip/product3@3x.png";
import product4 from "../../assets/img/products/product/alzap -zip/product4@3x.png";
import product5 from "../../assets/img/products/product/alzap -zip/product5@3x.png";
import product6 from "../../assets/img/products/product/alzap -zip/product6@3x.png";
...
const translations = {
  ar: {
    factoryName: "مصنع الزاب",
    tagline: "شبكة توزيع • جودة • ابتكار",
    heroDesc: "حلول بلاستيكية موثوقة لقطاعات الزراعة، الصناعة، والتغليف—معادلة قيمة/جودة ترفع سلة المشتريات.",
    requestQuote: "اطلب عرض سعر",
    downloadCatalog: "تحميل الكتالوج",
    aboutUs: "من نحن",
    aboutFactory: "نبذة عن المصنع",
    aboutText: "يركز مصنع الزاب على حلول التغليف الزراعي المتقدمة والري، وتصنيع أغشية الأسمدة لنباتات PET. تأسس عام 2018 ويساهم في إنتاج سنوي يتجاوز 18,000 طن من المنتجات البلاستيكية عالية الجودة.",
    manufacturingCapabilities: "القدرات التصنيعية",
    ourProducts: "منتجاتنا",
    productsDesc: "تشكيلة واسعة من منتجات التغليف والري مع إمكانية التخصيص الكامل",
    showing: "عرض",
    of: "من",
    product: "منتج",
    whyUs: "لماذا نحن؟",
    ...
    capabilities: [
      "إنتاج أفلام بلاستيكية زراعية متعددة الطبقات",
      "عبوات وتغليف مرن للاستخدامات التجارية والصناعية",
      "منتجات مساندة للوجستيات والتوزيع",
      "أغشية الأسمدة لنباتات PET",
      "تخصيص كامل حسب احتياجات المشروع",
      "ضمان الجودة وفق المعايير العالمية",
    ],
    advantages: [
      { title: "مواد خام معتمدة", desc: "معايير فحص جودة على كل دفعة إنتاج" },
      { title: "سلاسل توريد مرنة", desc: "تخصيص مواصفات حسب المشروع" },
      { title: "دعم فني", desc: "خدمة ما بعد البيع وتتبّع شحنات بسياسات SLA واضحة" },
    ...
    industries: [
      { title: "الزراعة", desc: "حلول بلاستيكية موثوقة للقطاع الزراعي والري" },
      { title: "الصناعة", desc: "منتجات بلاستيكية للمشاريع الصناعية الكبرى" },
      { title: "التغليف", desc: "حلول تغليف متكاملة للاستخدامات التجارية والصناعية" },
    ],
    sustainability: [
    ...
    products: [
      {
        ...
        specs: {
          ...
          weight: "22.5 جرام",
          neckFinish: "32 مم",
          tolerance: "±0.3 جرام وزن، ±0.5 مم طول",
          quantityInOctabin: "11,040 قطعة",
          capacity: "1 لتر",
        },
        additionalImages: [product1],
        contextImage: product1,
        technicalDrawing: product1,
        pdfUrl: "#",
      },
      {
        ...
        additionalImages: [product2],
        contextImage: product2,
        technicalDrawing: product2,
        pdfUrl: "#",
      },
      {
        ...
        specs: {
          ...
          weight: "8.5 جرام",
          neckFinish: "29/25 مم",
          tolerance: "±0.2 جرام وزن، ±0.5 مم طول",
          quantityInOctabin: "25,344 قطعة",
          quantityInTruck: "1,317,888 قطعة",
        },
        additionalImages: [product3],
        contextImage: product3,
        technicalDrawing: product3,
        pdfUrl: "#",
      },
      {
        title: "بريفورم ماء - 9 جرام",
        img: product4,
        desc: "بريفورم PET للماء بسعة 0.25-0.33 لتر. وزن 9 جرام مع مقياس قطر الفم 29/25 مم.",
        specs: {
          type: "0.25-0.33 لتر",
          weight: "9 جرام",
          neckFinish: "29/25 مم",
        ...
        additionalImages: [product4],
        contextImage: product4,
        technicalDrawing: product4,
        pdfUrl: "#",
      },
      {
        title: "بريفورم ماء - 10 جرام",
        img: product5,
        desc: "بريفورم PET للماء بسعة 0.33-0.5 لتر. وزن 10 جرام مع مقياس قطر الفم 29/25 مم.",
        specs: {
          type: "0.33-0.5 لتر",
          weight: "10 جرام",
          neckFinish: "29/25 مم",
          tolerance: "±0.2 جرام وزن، ±0.5 مم طول",
          quantityInOctabin: "24,096 قطعة",
          quantityInTruck: "1,252,992 قطعة",
        },
        additionalImages: [product5],
        contextImage: product5,
        technicalDrawing: product5,
        pdfUrl: "#",
      },
      {
        title: "بريفورم ماء - 10.5 جرام",
        img: product6,
        desc: "بريفورم PET للماء بسعة 0.25-0.50 لتر. وزن 10.5 جرام مع مقياس قطر الفم 29/25 مم.",
        specs: {
          type: "0.25-0.50 لتر",
          weight: "10.5 جرام",
          neckFinish: "29/25 مم",
        ...
        additionalImages: [product6],
        contextImage: product6,
        technicalDrawing: product6,
        pdfUrl: "#",
      },
      {
        title: "بريفورم ماء - 11.3 جرام",
        img: product1,
        desc: "بريفورم PET للماء. وزن 11.3 جرام مع مقياس قطر الفم 29/25 مم.",
        specs: {
          weight: "11.3 جرام",
          neckFinish: "29/25 مم",
          tolerance: "±0.2 جرام وزن، ±0.5 مم طول",
          quantityInOctabin: "24,096 قطعة",
          quantityInTruck: "1,252,392 قطعة",
        },
        additionalImages: [product1],
        contextImage: product1,
        technicalDrawing: product1,
      ...
      {
        title: "بريفورم ماء - 12 جرام",
        img: product2,
        desc: "بريفورم PET للماء. وزن 12 جرام مع مقياس قطر الفم 29/25 مم.",
        specs: {
          weight: "12 جرام",
          neckFinish: "29/25 مم",
          tolerance: "±0.2 جرام وزن، ±0.5 مم طول",
          quantityInOctabin: "24,000 قطعة",
          quantityInTruck: "1,252,392 قطعة",
        },
        additionalImages: [product2],
        contextImage: product2,
      ...
      {
        title: "بريفورم ماء - 24 جرام",
        img: product3,
        desc: "بريفورم PET للماء بسعة 1.5 لتر. وزن 24 جرام مع مقياس قطر الفم 29.25 مم.",
        specs: {
          type: "1.5 لتر",
          weight: "24 جرام",
          neckFinish: "29.25 مم",
          tolerance: "±0.2 جرام وزن، ±0.2 مم طول",
          quantityInOctabin: "11,040 قطعة",
          quantityInTruck: "574,080 قطعة",
        },
        additionalImages: [product3],
        contextImage: product3,
        technicalDrawing: product3,
      ...
      {
        title: "بريفورم PCO - 32 جرام",
        img: product4,
        desc: "بريفورم PET من نوع PCO بسعة 1 لتر. وزن 32 جرام.",
        specs: {
          type: "1 لتر",
          weight: "32 جرام",
          neckFinish: "1810",
          tolerance: "±0.2 جرام وزن، ±0.5 مم طول",
          quantityInOctabin: "8,352 قطعة",
          quantityInTruck: "434,304 قطعة",
        },
        additionalImages: [product4],
        contextImage: product4,
        technicalDrawing: product4,
  ...
  en: {
    factoryName: "Alzab Factory",
    tagline: "Distribution Network • Quality • Innovation",
    heroDesc: "Reliable plastic solutions for agriculture, industry, and packaging sectors—value/quality equation that elevates purchasing baskets.",
    requestQuote: "Request Quote",
    downloadCatalog: "Download Catalog",
    aboutUs: "About Us",
    aboutFactory: "About the Factory",
    aboutText: "Alzab Factory focuses on advanced agricultural packaging and irrigation solutions, manufacturing fertilizer films for PET plants. Established in 2018, it contributes to annual production exceeding 18,000 tons of high-quality plastic products.",
    manufacturingCapabilities: "Manufacturing Capabilities",
    ourProducts: "Our Products",
    productsDesc: "Wide range of packaging and irrigation products with full customization capabilities",
    showing: "Showing",
    of: "of",
    product: "products",
    whyUs: "Why Us?",
    ...
    kpis: [
      { value: "18K+", label: "Tons Annual Production" },
      { value: "95%", label: "Supply Commitment" },
      { value: "10", label: "Days Execution" },
      { value: "ISO", label: "Quality Standards" },
    ],
    capabilities: [
      "Production of multi-layer agricultural plastic films",
      "Flexible containers and packaging for commercial and industrial uses",
      "Supporting products for logistics and distribution",
      "Fertilizer films for PET plants",
      "Full customization according to project needs",
      "Quality assurance according to international standards",
    ],
    advantages: [
      { title: "Certified Raw Materials", desc: "Quality inspection standards on every production batch" },
      { title: "Flexible Supply Chains", desc: "Custom specifications according to project" },
      { title: "Technical Support", desc: "After-sales service and shipment tracking with clear SLA policies" },
    ...
    industries: [
      { title: "Agriculture", desc: "Reliable plastic solutions for agricultural sector and irrigation" },
      { title: "Industry", desc: "Plastic products for major industrial projects" },
      { title: "Packaging", desc: "Integrated packaging solutions for commercial and industrial uses" },
    ],
    sustainability: [
    ...
    products: [
      {
        title: "Oil Preform - 22.5 gr",
        img: product1,
        desc: "PET preform for oil with 1 liter capacity. Weight 22.5 grams with neck finish 32 mm.",
        specs: {
          type: "1L1",
          weight: "22.5 gr",
          neckFinish: "32 mm",
          tolerance: "±0.3 gr weight, ±0.5 mm length",
          quantityInOctabin: "11,040 pcs",
          capacity: "1 liter",
        },
        additionalImages: [product1],
        contextImage: product1,
      ...
      {
        title: "Oil Preform - 25 gr",
        img: product2,
        desc: "PET preform for oil with 1 liter capacity. Weight 25 grams with neck finish 32 mm.",
        specs: {
          type: "1Lt",
          weight: "25 gr",
          neckFinish: "32 mm",
      ...
      {
        title: "Water Preform - 8.5 gr",
        img: product3,
        desc: "PET preform for water with 0.25-0.33 liter capacity. Weight 8.5 grams with neck finish 29/25 mm.",
        specs: {
          type: "0.25-0.33 liter",
          weight: "8.5 gr",
          neckFinish: "29/25 mm",
          tolerance: "±0.2 gr weight, ±0.5 mm length",
          quantityInOctabin: "25,344 pcs",
          quantityInTruck: "1,317,888 pcs",
        },
        additionalImages: [product3],
        contextImage: product3,
        technicalDrawing: product3,
      ...
      {
        title: "Water Preform - 9 gr",
        img: product4,
        desc: "PET preform for water with 0.25-0.33 liter capacity. Weight 9 grams with neck finish 29/25 mm.",
        specs: {
          type: "0.25-0.33 liter",
          weight: "9 gr",
          neckFinish: "29/25 mm",
      ...
      {
        title: "Water Preform - 10 gr",
        img: product5,
        desc: "PET preform for water with 0.33-0.5 liter capacity. Weight 10 grams with neck finish 29/25 mm.",
        specs: {
          type: "0.33-0.5 liter",
          weight: "10 gr",
          neckFinish: "29/25 mm",
          tolerance: "±0.2 gr weight, ±0.5 mm length",
          quantityInOctabin: "24,096 pcs",
          quantityInTruck: "1,252,992 pcs",
        },
        additionalImages: [product5],
        contextImage: product5,
        technicalDrawing: product5,
      ...
      {
        title: "Water Preform - 10.5 gr",
        img: product6,
        desc: "PET preform for water with 0.25-0.50 liter capacity. Weight 10.5 grams with neck finish 29/25 mm.",
        specs: {
          type: "0.25-0.50 liter",
          weight: "10.5 gr",
          neckFinish: "29/25 mm",
          tolerance: "±0.2 gr weight, ±0.5 mm length",
          quantityInOctabin: "24,096 pcs",
      ...
      {
        title: "Water Preform - 11.3 gr",
        img: product1,
        desc: "PET preform for water. Weight 11.3 grams with neck finish 29/25 mm.",
        specs: {
          weight: "11.3 gr",
          neckFinish: "29/25 mm",
          tolerance: "±0.2 gr weight, ±0.5 mm length",
          quantityInOctabin: "24,096 pcs",
          quantityInTruck: "1,252,392 pcs",
        },
        additionalImages: [product1],
        contextImage: product1,
        technicalDrawing: product1,
      ...
      {
        title: "Water Preform - 12 gr",
        img: product2,
        desc: "PET preform for water. Weight 12 grams with neck finish 29/25 mm.",
        specs: {
          weight: "12 gr",
          neckFinish: "29/25 mm",
          tolerance: "±0.2 gr weight, ±0.5 mm length",
          quantityInOctabin: "24,000 pcs",
          quantityInTruck: "1,252,392 pcs",
        },
        additionalImages: [product2],
        contextImage: product2,
      ...
      {
        title: "Water Preform - 24 gr",
        img: product3,
        desc: "PET preform for water with 1.5 liter capacity. Weight 24 grams with neck finish 29.25 mm.",
        specs: {
          type: "1.5 liter",
          weight: "24 gr",
          neckFinish: "29.25 mm",
          tolerance: "±0.2 gr weight, ±0.2 mm length",
          quantityInOctabin: "11,040 pcs",
          quantityInTruck: "574,080 pcs",
        },
        additionalImages: [product3],
        contextImage: product3,
        technicalDrawing: product3,
      ...
      {
        title: "PCO Preform - 32 gr",
        img: product4,
        desc: "PCO type PET preform with 1 liter capacity. Weight 32 grams.",
        specs: {
          type: "1 liter",
          weight: "32 gr",
          neckFinish: "1810",
          tolerance: "±0.2 gr weight, ±0.5 mm length",
          quantityInOctabin: "8,352 pcs",
          quantityInTruck: "434,304 pcs",
        },
        additionalImages: [product4],
        contextImage: product4,
        technicalDrawing: product4,
...
function StatCard({ stat, index, icon: Icon }: any) {
  return (
    <div
      className="relative overflow-hidden rounded-lg bg-white p-4 sm:p-6 shadow-md border border-gray-200 hover:shadow-lg hover:border-emerald-300 transition-shadow duration-200"
    >
...
export default function AlzabCompany() {
      ...
      <section className="relative py-12 sm:py-16 lg:py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 w-full">
          <div className="max-w-7xl mx-auto">
            ...
            {/* Main Content Grid */}
            <div className={`flex flex-col lg:flex-row gap-6 sm:gap-8 items-stretch ${isRTL ? '' : 'lg:flex-row-reverse'}`}>
              {/* Cards Section */}
              <div className="space-y-5 sm:space-y-6 flex flex-col lg:w-1/2">
                {/* About Factory Card */}
                <div className="bg-white rounded-xl p-6 sm:p-8 shadow-md border border-gray-200 flex flex-col">
                  <div className="flex items-center gap-4 mb-4 sm:mb-5">
                    <div className="h-12 w-12 sm:h-14 sm:w-14 rounded-xl bg-emerald-600 flex items-center justify-center">
                ...
                <div className="bg-white rounded-xl p-6 sm:p-8 shadow-md border border-gray-200 flex flex-col max-h-[400px] sm:max-h-[450px]">
                  <div className="flex items-center gap-4 mb-4 sm:mb-5">
                    <div className="h-12 w-12 sm:h-14 sm:w-14 rounded-xl bg-teal-600 flex items-center justify-center">
                  ...
                  <ul className="space-y-2.5 sm:space-y-3 flex-1 overflow-y-auto custom-scrollbar">
                    {t.capabilities.map((cap: string, i: number) => (
                      <li key={i} className="flex items-start gap-3">
                        <div className="mt-1 h-5 w-5 sm:h-6 sm:w-6 rounded-full bg-emerald-600 flex items-center justify-center flex-shrink-0">
              ...
              <div className="flex items-center justify-center lg:w-1/2">
                <div className="relative w-full max-h-[500px] sm:max-h-[550px] bg-gray-50 rounded-xl p-8 sm:p-10 lg:p-12 shadow-md border border-gray-200 flex items-center justify-center aspect-square">
                  <img
                    src={logoAlzab}
                    alt={t.factoryName}
            ...
            <div className="grid lg:grid-cols-3 gap-6 sm:gap-8">
              <div className="lg:col-span-2 bg-white rounded-2xl p-6 sm:p-8 shadow-xl border border-gray-100">
                ...
                <div className="rounded-xl overflow-hidden shadow-lg">
                  <iframe
                    title={isAR ? "خريطة مصنع الزاب" : "Alzab Factory Map"}
                    src={mapSrc(hq)}
